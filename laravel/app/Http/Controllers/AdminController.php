...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $travel_packages = TravelPackage::where('id_user', $idUser)->join('ranking', 'travel_packages.id', '=', 'ranking.id_alternatif')->orderBy('ranking.nilai', 'DESC')->get();
        ...
        return view('admin.dashboard', compact('alternatif', 'travel_packages', 'cekKonsistensi', 'konsistensi'));
    ...
    public function process()
    {
        ...
        return redirect()->route('dashboardahp');
    }
}
