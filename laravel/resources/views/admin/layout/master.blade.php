...
<head>
  ...
  <meta name="author" content="Sofa">
  <title>@yield('title')</title>
  <!-- Favicon -->
  <link href="{{ asset('img/brand/logoCompany.png') }}" rel="icon" type="image/png">
  <!-- Fonts -->
  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <a class="navbar-brand pt-0" href="./index.html">
        <img src="{{ asset('img/brand/logoCompany.png') }}" class="navbar-brand-img" alt="...">
        <br>
        <h4>Lovely Corpin Tour & Travel</h4>
      </a>
      <!-- User -->
          ...
          <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <div class="media align-items-center">
              <span class="avatar avatar-sm rounded-circle">
                <img alt="Image placeholder" src="{{ asset('img/brand/logoCompany.png') }}">
              </span>
            </div>
          </a>
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link" href="{{ route('dashboardahp') }}">
              <i class="ni ni-tv-2 text-primary"></i> Dashboard
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('kriteria.index') }}">
              <i class="ni ni-tag text-blue"></i> Kriteria
            </a>
          </li>
          <!--<li class="nav-item">-->
          <!--  <a class="nav-link" href="{{ route('alternatif.index') }}">-->
          <!--    <i class="ni ni-collection text-orange"></i> Alternatif-->
          <!--  </a>-->
          <!--</li>-->
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('bobot-alternatif.index') }}">
              <i class="ni ni-vector text-red"></i> Bobot Alternatif
            </a>
          </li>
          <li class="nav-item">
