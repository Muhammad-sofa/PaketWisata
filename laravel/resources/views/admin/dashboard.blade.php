        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table align-items-center table-flush">
              ...
              <tbody>
                @foreach($travel_packages as $i)
                <tr>
                  <th>{{ $i->title }}
                    <div class="travel-button mt-auto">
                        <a href="{{route('detail', $i->slug)}}" class="btn btn-travel-details px-4">View Details</a>
                    </div>
                  </th>
                  <td>{{ $i->nilai }}</td>
                </tr>
...
<script>
  $(document).ready(function(){
    ...
    var travel_packages = {!! $travel_packages !!};
    console.log(travel_packages);

    var label = [];
    var value = [];
    for(var data in travel_packages){
      label.push(travel_packages[data]['title']);
      value.push(travel_packages[data]['nilai']);
         }
