                        ...
                        <div class="card card-details">
                            ...
                            <div class="member mt-3">
                                ...
                                <form class="form-inline" method="post" action="{{route('checkout-create', $item->id)}}">
                                    @csrf
                                    <!-- sr adalah screen reader hanya muncul jika menggunakan tools accessbility -->
                                ...
                                <p class="disclaimer mb-0">
                                    You are only able to invite member that has registered in Lovely Corpin Tour &
                                    Travel
                    ...
                    <div class="col lg-4">
                        <div class="card card-details card-right">
                            ...
                            <table class="trip-information">
                                ...
                                <tr>
                                    ...
                                    <td width="50%" class="text-right">
                                        Rp. {{ number_format($item->travel_package->price) }},00 / person
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <p class="payment-instructions">
                                You will be redirected to another page to pay using G0-PAY
                            </p>
                        <img src="{{url('frontend/images/Gopay.png')}}" class="w-50">
                            <div class="bank">
                                ...
                                <img src="{{url('frontend/images/ic_bank.png')}}" class="bank-image">
                                    <div class="description">
                                        <h3>PT.Lovely Corpin Travel ID</h3>
                                        <p>
                                            Bank Mandiri
                                            <br>
                                            1111 3333 5555
